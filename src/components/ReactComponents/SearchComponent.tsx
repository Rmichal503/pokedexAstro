...
export default function SearchComponent() {
  ...
  return (
    <div className='border-2 xl:border-[4px] border-slate-900 flex flex-col items-center justify-center rounded-lg xl:rounded-xl px-4 py-6 md:px-6 md:py-8 2xl:px-8 2xl:py-10 space-y-3 xl:space-y-6 w-fit'>
